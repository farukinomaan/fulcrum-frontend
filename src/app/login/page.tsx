...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans">
      ...
      <div className="w-full lg:w-[35%] flex flex-col justify-center px-8 sm:px-12 relative z-10 border-r border-slate-100 bg-zinc-200">
        ...
        <div className="max-w-sm w-full mx-auto">
          <div className="mb-10">
            ...
            <p className="text-slate-500 text-lg">
              Your financial intelligence unit is ready.
            </p>
          </div>
          ...
          <button 
            ...
            className="w-full bg-white border border-slate-200 text-slate-700 font-medium py-4 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center justify-center gap-3 shadow-sm group"
          >
      ...
      <div className="hidden lg:flex lg:w-[65%] bg-zinc-950 flex-col items-center justify-center relative">
        
        {/* Text Content (Above Animation) */}
        <div className="text-center z-10 mb-8 max-w-2xl px-6">
           <h2 className="text-white text-3xl font-medium mb-3 tracking-wide">
             Unified Financial Intelligence
           </h2>
           <p className="text-slate-400 text-base leading-relaxed">
             Connect your banking, accounting, and payment stacks into one self-reconciling core.
           </p>
        </div>
